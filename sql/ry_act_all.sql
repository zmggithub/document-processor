...
-- 2022-11-19
-- ALTER TABLE
ALTER TABLE `biz_leave` ADD COLUMN `file_name` VARCHAR(128) NULL COMMENT '附件名称' AFTER `reality_end_time`, ADD COLUMN `file_path` VARCHAR(512) NULL COMMENT '附件路径' AFTER `file_name`; 